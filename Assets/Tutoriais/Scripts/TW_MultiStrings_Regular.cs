...
public class TW_MultiStrings_Regular_Editor : Editor
{
	...
	public  static string[] PointerSymbols = { "None", "<", "_", "|", ">" };
	public  TW_MultiStrings_Regular TW_MS_RegularScript;
	...
	public  void MakeArrayGUI(SerializedObject obj, string name)
    {
	...
	public  void MakePopup(SerializedObject obj)
    {
...
public class TW_MultiStrings_Regular : MonoBehaviour {
	...
	public  void NewLineCheck(string S)
    {
        if (S.Contains("\n"))
        {
	...
	public  IEnumerator MakeTypewriterText(string ORIGINAL, string POINTER)
    {
        start = false;
	...
	public  IEnumerator MakeTypewriterTextWithNewLine(string ORIGINAL, string POINTER, List<int> List)
    {
        start = false;
        if (сharIndex != ORIGINAL.Length + 1)
        {
	...
	public  List<int> MakeList(string S)
    {
	...
	public  string InsertNewLine(string _TEXT, List<int> _List)
    {
